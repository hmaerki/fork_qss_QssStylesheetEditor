...
print(
    "add item fontWeight, and value is set to:{}".format(
        config["general.editor.fontWeight"]
    )
)
...
# list item operation
config.insertToChild(
    "general.editor.font", 0, "Arial"
)  # change font from str to list and insert item
config.appendToChild(
    "general.editor.font", "SimSun"
)  # font=["Arial", "Roman", "SimSun"]
